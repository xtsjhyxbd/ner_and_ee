...
LTP_DATA_MODELDIR = "E:\\nlp_data\\3.3.0\\ltp_data"
segmentor = Segmentor()
segmentor.load(os.path.join(LTP_DATA_MODELDIR, "cws.model"))
postagger = Postagger()
postagger.load(os.path.join(LTP_DATA_MODELDIR, "pos.model"))
parser = Parser()
parser.load(os.path.join(LTP_DATA_MODELDIR, "parser.model"))
recognizer = NamedEntityRecognizer()
recognizer.load(os.path.join(LTP_DATA_MODELDIR, "ner.model"))

in_file_name = "./data/input.txt"
out_file_name = "./data/output.txt"
begin_line = 1
end_line = 5
